...
csvwrite(['./photonFiles/',fileName,'_photons.csv'], [x, y, z, x_comp, y_comp, z_comp]);
...
sprintf("/dataCollection/setHitFileName hit_%s.csv", fileName) 
sprintf("/dataCollection/setSignalFileName signal_%s.csv", fileName) 
""
sprintf("/dataCollection/setPhotonFileName %s_photons.csv", fileName)
""
"# E0 of background distribution out of {100,200,300} keV"
sprintf("/particleSource/setFoldingEnergy %.3f # [keV]", photon_E0) 
""
